...
void init_robot_steps(MotorInfo* motorInfo, SensorInfo* sensorInfo) {
    ...
    global_params.robot_steps[0].robot_turn_right_to_ideal_angle = 70.0f;
    global_params.robot_steps[0].init_step = &robotturnrighttoidealangle_init_step;
    global_params.robot_steps[0].run_motor = &robotturnrighttoidealangle_run_motor;
    global_params.robot_steps[0].update_all = &robotturnrighttoidealangle_update;
