...
void init_robot_steps(MotorInfo* motorInfo, SensorInfo* sensorInfo) {
    ...
    global_params.robot_steps[0].robot_run_straight_until_wall_distance_to_stop = 15; // in cm
    global_params.robot_steps[0].robot_run_timed_time_to_run = 2000.0f;
    global_params.robot_steps[0].robot_run_timed_speed = -400;
    global_params.robot_steps[0].robot_turn_left_degree = 10;
    global_params.robot_steps[0].robot_turn_right_degree = 10;
    global_params.robot_steps[0].init_step = &robotscanforballstep_init_step;
    global_params.robot_steps[0].run_motor = &robotscanforballstep_run_motor;
    global_params.robot_steps[0].update_all = &robotscanforballstep_update;
