...
void init_robot_steps(MotorInfo* motorInfo, SensorInfo* sensorInfo) {
    ...
    global_params.robot_steps[0].init_step = &robotscanforball_init_step;
    global_params.robot_steps[0].run_motor = &robotscanforball_run_motor;
    global_params.robot_steps[0].update_all = &robotscanforball_update;
