...
void robotscanforballstep_update(MotorInfo *motorInfo, SensorInfo *sensorInfo);


// call this function in the run motor function of the loop
void robotscanforballstep_run_motor(MotorInfo *motorInfo, SensorInfo *sensorInfo);
...
// state
void robotscanforballstep_init_step(MotorInfo *motorInfo, SensorInfo *sensorInfo);
